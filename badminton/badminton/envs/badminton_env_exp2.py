...
class BadmintonEnv(gym.Env):
    def __init__(self):
        ...
        self.min_action_space_attr = np.array([-1.4,])
        self.max_action_space_attr = np.array([np.pi/2.01,])
    ...
    def shuttle_trajectory_wrt_t(self, vi, thetai, t):
        ...
        try:
            ...
            print(self.chance, vi, thetai/np.pi, cos(thetai), t)
    ...
    def getShuttleAttributesForP1(self):
        if self.shuttle_within_range('p1'):
            #return one of hard coded trajectories
            speed_of_return, thetai_val = 30, -0.1#self.getRandomVelocityTheta()#30, -0.01
            psi = None
