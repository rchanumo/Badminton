...
class RenderCourt():
    ...
    def printLanding(self):
        glColor3f(1.0, 1.0, 1.0)
        glBegin(GL_LINES)
        xcord = self.landing_point[0]
        ycord = self.landing_point[1]
        zcord = self.landing_point[2]
        glVertex3fv((xcord+10, ycord+10, zcord))
        glVertex3fv((xcord+10, ycord-10, zcord))
        glVertex3fv((xcord+10, ycord-10, zcord))
        glVertex3fv((xcord-10, ycord-10, zcord))
